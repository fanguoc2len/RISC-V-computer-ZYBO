## Basys 3 constraints subset
## Ref: Digilent Basys-3 Master XDC
...
## SD card via JA PMOD adapter
## Adjust if your adapter uses another PMOD header.
set_property PACKAGE_PIN J1 [get_ports sd_cs_n]
