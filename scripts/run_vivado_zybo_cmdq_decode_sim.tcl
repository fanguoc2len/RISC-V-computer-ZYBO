...
set saved_log [file join $build_dir vivado_zybo_cmdq_decode_stub.log]

cd $repo_dir
source [file join $script_dir create_vivado_zybo_project.tcl]

catch {close_sim}
set_property top accel_cmdq_desc_decode_stub_tb [get_filesets sim_1]
update_compile_order -fileset sim_1

puts "Starting command-queue descriptor decode stub simulation..."
...
if {[string first "PASS: command-queue descriptor decode stub regression completed." $contents] < 0} {
    error "PASS marker was not found in $saved_log"
}

puts "Verified command-queue descriptor decode stub."
puts "  log: $saved_log"
